...
import ru.mirea.alyamovskiyvy.Lesson4.databinding.FragmentGalleryBinding;
...
public class MusicPlayerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final TextView title = binding.musicTitle;
        title.setText("Название музыкального произведения");
        return root;
    }
